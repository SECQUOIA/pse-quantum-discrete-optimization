...
Section~3 derives the exact auxiliary-repair decomposition that reduces per-sample repair to 34 comparisons.
...
Exact enumeration confirms there are exactly 36 feasible flows (ranks 1--36); the remaining 14 shown here are infeasible flows whose penalty values are insufficient to place them above all feasible ones.
