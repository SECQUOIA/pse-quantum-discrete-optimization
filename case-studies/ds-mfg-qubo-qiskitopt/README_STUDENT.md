...
- simulator-to-hardware comparison tables in
  ...
  Aer and hardware hit rates and reserves model-based noisy columns for the
  overnight FakeFez/Aer runner.
...
- `ds_mfg_simulator_hardware_comparison/`: cached ideal Aer, pending noisy
  model, and hardware comparison tables.
