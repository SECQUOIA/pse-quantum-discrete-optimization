...
practical for this circuit. The audit also persists the same $p=2$
...
\texttt{scripts/run\_direct\_full\_qubo\_hardware\_pilot.jl} consumes that
artifact to build a dry-run-safe direct full-QUBO IBM Runtime handoff; actual
submission remains gated by
