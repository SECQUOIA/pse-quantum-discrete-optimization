...
for top-50, top-10, global-optimum, and feasible Gurobi-pool events. &
...
feasible Gurobi-pool events. The feasible event counts sampled flows whose
repaired projection matches either \texttt{global\_optimum} or
\texttt{gurobi\_pool}. Each rate is paired with a two-sided 95\% Wilson score
confidence interval. The same rows report empirical 99\% time to solution,
...
\centering
\scriptsize
\caption{Representative global-optimum and feasible-hit empirical 99\% time to
...
\hline
Run & Optimal hits & Optimal \texttt{tts99\_sec} & Feasible hits & Feasible \texttt{tts99\_sec} \\
\hline
