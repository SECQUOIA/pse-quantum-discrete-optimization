...
the QAOA and VQE summaries. The compact distribution cache retains all sampled
top-50 flows and each run's best sampled flow, while the summary records counts
