...
DS-MFG discrete manufacturing QUBO instance using \texttt{QiskitOpt.jl}, plus a
small fixed-parameter IBM hardware pilot for the strongest QAOA handoff. The
