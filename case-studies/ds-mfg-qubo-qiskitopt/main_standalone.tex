...
This study answers a narrower question: not whether quantum optimization solves the DS-MFG instance efficiently, but what must happen for a QAOA or VQE distribution to yield meaningful process-design samples.
...
Exact auxiliary repair is tractable here only because the conditioned auxiliary graph decomposes into 13 independent components (see Supplement); in general, it is NP-hard, and an approximate repair would change the meaning of every reported metric.
