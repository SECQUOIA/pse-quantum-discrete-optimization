...
Both workflows contain variational circuit parameters optimized here with COBYLA \cite{Cerezo2021}.
...
\hline
\multicolumn{6}{@{}p{0.99\linewidth}@{}}{\footnotesize\itshape Key counts: QAOA $p{=}5$: 664 opt.\ hits and 32502 feas.\ hits in 262144 reads. IBM \texttt{ibm\_fez}: 0 opt.\ hits and 4 feas.\ hits in 36864 reads.} \\
\end{tabular}
\end{table*}
...
The resulting TTS99-feas is 84.6 s, roughly 14000$\times$ slower than the hill climber's 0.006 s and 1200$\times$ slower than Gurobi's 0.073 s, primarily because elapsed time is dominated by cloud-job overhead rather than circuit-execution time.
